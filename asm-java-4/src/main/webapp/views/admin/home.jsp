      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="/asm-java-4/admin" class="nav-link active">
           ...
           <li class="nav-item menu-open">
            <a href="/asm-java-4/admin/video?action=view" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Video
                <i class="right fas fa-angle-left"></i>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/asm-java-4/admin/video?action=add"class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New or Edit</p>
                </a>
              </li>
    ...
    <section class="content">
    	<div class="card">
    		<div class="card-header">
    			<h3 class="card-title"> Favorites Statistics</h3>
    		</div>
                  ...
                  <tbody>
                  		<c:forEach items="${videos}" var="item">
	                  		<tr>
			                    ...
			                    <td>${item.title }</td>
			                    <td><a href="video?action=watch&id=${item.href}">${item.href }</a>
			                    </td>
...
<script>
  ...
  selectVideo.onchange = function() {
	  var videoHref = document.getElementById('selectVideo').value;
	  /* var videoHref = test.val(); */
  	   $.ajax({
