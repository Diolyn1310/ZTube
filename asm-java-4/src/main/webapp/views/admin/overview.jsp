                  ...
                  <tbody>
                  		<c:forEach items="${videos}" var="item">
	                  		<tr>
			                    ...
			                    <button type="button" onclick="deleteVideo('${item.href}')" class="btn btn-success">
			                    	Delete
			                    </button>   	
								</td>
...
<script>
    ...
    function deleteVideo(href){
    	$.ajax({
    		url: '/asm-java-4/admin/video?action=delete&href=' + href
    	}).then(function(data){
    		window.location.href = "http://localhost:8080/asm-java-4/admin/video?action=view";
